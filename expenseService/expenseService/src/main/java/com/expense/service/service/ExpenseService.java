...
public class ExpenseService
{
    ...
    /**
     * Check if expense already exists (for idempotency)
     */
    public boolean expenseExists(String userId, String externalId){
        if(Objects.isNull(userId) || Objects.isNull(externalId)){
            return false;
        }
        Optional<Expense> expenseOpt = expenseRepository.findByUserIdAndExternalId(userId, externalId);
        return expenseOpt.isPresent();
    }
